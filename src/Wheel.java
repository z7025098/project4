...
public class Wheel {
    ...
    public final static int MIN_NUM   =  0;			// smallest number to bet
    public final static int MAX_NUM   = 37;			// largest number to bet
    public final static int MAX_BET   = 10;			// largest amount to bet
    public final static int MIN_BET   = 0;			// smallest amount to bet
    ...
    //=====================================================================
    //  Presents options for each rounds
    //=====================================================================
    public static void roundOptions() {
        ...
        System.out.println("    4. Ready for the game!");
        System.out.println("    5. Leave the game and return to the game menu");
    }
